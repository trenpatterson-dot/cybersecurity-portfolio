...
This format provides a clear and concise overview of the key findings, steps performed, and gaps in incident response, as well as recommendations for improvement.